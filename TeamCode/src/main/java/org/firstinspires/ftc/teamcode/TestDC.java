...
@TeleOp(name="Winch Test", group="Iterative Opmode")
//@Disabled
public class TestDC extends OpMode
{
    ...
    private boolean upPressed = true; //checks if the up/down button is unpressed before running method code again
    ...
    private double blockHeight = 4; //inches
    private double tickToRev = 1120; //for Neverest 40s
...
/*
        ...
        */
        ...
        changeTowerHeight();
        telemetry.addData("currentHeight:", activeWinch.getCurrentPosition());
...
*/
    ...
    public void changeTowerHeight()
    {
        int currentHeight = activeWinch.getCurrentPosition();
        if (Math.abs(towerHeight-currentHeight)<5)
        {
            activeWinch.setPower(0);
            passiveWinch.setPower(0);
        }
        else if (towerHeight-currentHeight < 1000 && towerHeight-currentHeight > 0)
        {
            activeWinch.setPower(-.005*(Math.abs(towerHeight-currentHeight)));
            passiveWinch.setPower(-.005*(Math.abs(towerHeight-currentHeight)));
        }
        else if (towerHeight-currentHeight > -1000 && towerHeight-currentHeight < 0)
        {
            activeWinch.setPower(.005*(Math.abs(towerHeight-currentHeight)));
        ...
        else if (towerHeight > currentHeight)
        {
